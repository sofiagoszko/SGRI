...
function Login() {
  ...
  const { nombre, apellido, email, password, userName, legajo, cargo, departamento } = empleado;
      ...
      <div className="bg-white p-5 rounded-5 card__registro">
        ...
        <form onSubmit={onSubmit} className="row justify-content-center">
          ...
          <div className="d-flex justify-content-evenly">
            <Link to="/home" className="btn btn-danger text-white align-self-center px-5 mt-3">
              Cancelar
            </Link>
            <button type="submit" className="btn btn-login-success text-white align-self-center px-5 mt-3">
              Aceptar
            </button>
          </div>
        </form>
